...
- **Dev Server URL**: `http://127.0.0.1:5234`
- **Preview URL**: `https://api.chitterchat.co.uk/chipify/projects/11686527-6fca-4a93-a66a-0be6900f229d/preview`
- **Port**: `5234`
...
4. The dev server is accessible at `http://127.0.0.1:5234`
5. Preview the application using the preview URL: `https://api.chitterchat.co.uk/chipify/projects/11686527-6fca-4a93-a66a-0be6900f229d/preview`
